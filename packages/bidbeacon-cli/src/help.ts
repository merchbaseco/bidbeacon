...
const TOPICS: Record<HelpTopicKey, HelpTopic> = {
    global: {
        ...
        commands: [
            ...
            { left: 'asins', right: 'Inspect ASIN topology and performance overviews' },
    ...
    asins: {
        ...
        summary: 'Inspect ASIN topology and overviews',
        options: [
        ...
        commands: [
            ...
            { left: 'overview <asin>', right: 'Fetch ASIN-level performance summary' },
        ],
        notes: [
    ...
    metrics: {
        ...
        notes: [
            'Common flags: --metrics <keys> --range <range> --asin <ASIN> --filter <expr> (repeatable) --search <text> --state <value> --all',
    ...
    'metrics series': {
        ...
        options: [
            ...
            { left: '--asin <ASIN>', right: 'Scope to entities connected to an ASIN' },
