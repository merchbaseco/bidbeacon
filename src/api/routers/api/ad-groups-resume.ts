...
import { adGroupsGetOutputSchema, adGroupsStateInputSchema } from '@/api/schemas/cli';
...
export const adGroupsResume = apiProcedure
    ...
    .mutation(async ({ ctx, input }) => {
        ...
        await updateAdGroupRow(input.adGroupId, { state: 'ENABLED' });
        return { item };
    });
