...
export const ams_cm_campaigns = pgTable('ams_cm_campaigns', {
    ...
    budgetBudgetCapRecurrenceRecurrenceType: text('budget_budget_cap_recurrence_recurrence_type'),
...
export const ams_sp_traffic = pgTable('ams_sp_traffic', {
    ...
    timeWindowStart: timestamp('time_window_start', { withTimezone: true, mode: 'date' }).notNull(),
