...
import type { SearchCoverage, SearchCoverageIssue } from './search-coverage';
import type { SearchDateRange } from './search-planner';

export const queryCampaignPlacementSearchCoverage = async (
    ...
    const rows = await context.db
        ...
        .where(
            and(
                ...
                eq(reportDatasetMetadata.entityType, 'placement'),
