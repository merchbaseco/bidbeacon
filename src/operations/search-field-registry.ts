...
export const SEARCH_FIELDS = [...AD_SEARCH_FIELDS, ...TARGET_RESOURCE_FIELDS, ...PRODUCT_RESOURCE_FIELDS, ...CHANGE_EVENT_RESOURCE_FIELDS, 'segments.placement'] as const;
...
export const searchFieldRegistry: Readonly<Record<SearchField, SearchFieldDefinition>> = {
    ...
    'target.negative': definition('target.negative', 'boolean', booleanOperators, targetResource),
    'target.keyword': definition('target.keyword', 'string', nameOperators, targetResource),
    'target.asin': definition('target.asin', 'string', stringEqualityOperators, targetResource),
    'target.matchType': definition('target.matchType', 'string', stringEqualityOperators, targetResource),
    ...
    'metrics.cvr': definition('metrics.cvr', 'number', numericOperators, performanceResources, [], { performance: true }),
