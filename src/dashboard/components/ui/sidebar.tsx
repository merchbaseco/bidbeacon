...
function SidebarMenuButton({
    ...
    return (
        <Tooltip>
            <TooltipTrigger render={buttonElement as ReactElement<Record<string, unknown>>} />
...
function SidebarMenuSkeleton({
    ...
    return (
        <div className={cn('flex h-8 items-center gap-2 rounded-lg px-2', className)} data-sidebar="menu-skeleton" data-slot="sidebar-menu-skeleton" {...props}>
